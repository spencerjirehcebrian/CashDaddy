...
class Config {
  ...
  constructor() {
    ...
    this.APP_URL_USER = process.env.APP_URL_USER || 'http://localhost:3000/api';
    this.APP_URL_KYC = process.env.APP_URL_KYC || 'http://localhost:3001/api';
    this.APP_URL_WALLET = process.env.APP_URL_WALLET || 'http://localhost:3002/api';
    this.APP_URL_PAYMENT = process.env.APP_URL_PAYMENT || 'http://localhost:3003/api';
  }
