...
class KYCService {
    static async submitOrUpdateKYC(userId, kycData) {
    ...
    static async rejectKYC(kycId, rejectionReason) {
        if (!rejectionReason) {
...
], KYCService, "submitOrUpdateKYC", null);
__decorate([
    (0, caching_decorator_1.Cacheable)({ keyPrefix: 'kyc' })
], KYCService, "getKYCStatus", null);
__decorate([
    (0, caching_decorator_1.CacheInvalidate)({ keyPrefix: 'kyc' })
], KYCService, "approveKYC", null);
__decorate([
    (0, caching_decorator_1.CacheInvalidate)({ keyPrefix: 'kyc' })
], KYCService, "rejectKYC", null);
